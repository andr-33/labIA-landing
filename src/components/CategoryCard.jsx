const CategoryCard = ({category, description, handelCategory}) => {
    return(
        <div
            className="bg-[#FFFFFF1A] rounded-lg p-5 m-2 shadow-lg transition-transform transform hover:-translate-y-1 hover:shadow-lg cursor-pointer w-full sm:w-[300px] "
